...
<body>
  <div id="contains">
    ...
    <div id="gcoey">
      <div class="welcome">
        ...
        <p>Even if you don’t often have the opportunity to visit campus, many of the library’s collections and services
          are open to you. Through this website, you’ll find access to scholarly journal articles and databases,links to
          treasures from our special collections, information on exhibits in our libraries, and updates on library
          events.</p>
      </div>
      <div class="notice">
        <h2>Notice</h2>
    ...
    <section id="facilities">
      ...
      <div id="services">
        <a href="papers.php" target="blank">
          <div class="box">
  ...
  <div id="imp">
    ...
    <div id="half">
      <div class="dbatu">
        ...
        <p class="card-text">The University is committed to provide quality technical education, research and
          development services to meet the needs of industry, business, service sector and society, at large.</p>
      ...
      <div class="dbatu">
        ...
        <p class="card-text">Govt College of Engineering, Yavatmal (GCOEY) promises to fulfill quality technical human
          resource needed for these sectors in India.</p>
        <button class="vew"><a href="https://gcoey.ac.in/" target="blank">View</a></button>
      </div>
      <div class="dbatu">
        <img src="intershala.jpeg" width="100%" height="180px">
        <h5 class="card-title"><a
            href="https://trainings.internshala.com/?utm_source=Google-Search&utm_campaign=CT-Search-Brand-Oct22&utm_adgroup=Brand&utm_locationinterest=&utm_searchkeyword=internshala&utm_keywordid=kwd-296575527534&gclid=Cj0KCQiAvqGcBhCJARIsAFQ5ke6jas4fvUUyE_nIIOGTMyN3yR_L_o2UmgMsx0LJXgGFYyTkYUmvAIkaAknlEALw_wcB"
            target="blank">INTERNSHALA</a></h5>
        <p class="card-text">Internshala Trainings certificate is recognized by over 1.8 lakh companies. Enroll now. Get
          Internship & Job Preparation Training Free With Online Courses.
        </p>
        <button class="vew"><a
            href="https://trainings.internshala.com/?utm_source=Google-Search&utm_campaign=CT-Search-Brand-Oct22&utm_adgroup=Brand&utm_locationinterest=&utm_searchkeyword=internshala&utm_keywordid=kwd-296575527534&gclid=Cj0KCQiAvqGcBhCJARIsAFQ5ke6jas4fvUUyE_nIIOGTMyN3yR_L_o2UmgMsx0LJXgGFYyTkYUmvAIkaAknlEALw_wcB"
    ...
    <div id="full">
      <div class="dbatu">
        ...
        <p class="card-text">The Directorate has under it’s development and supervisory ambit, around 1600 Technical
          Education institutions across the state of Maharashtra.</p>
      ...
      <div class="dbatu">
        ...
        <h5 class="card-title"><a
            href="https://mahadbtmahait.gov.in/SchemeData/SchemeData?str=E9DDFA703C38E51AA07C7E01997E4885"
            target="blank">DBT</a></h5>
        <p class="card-text">Maha DBT – Online direct benefit transfer scheme to distribute scholarships for students
          studying in Maharashtra state by the government of Maharashtra.</p>
        <button><a href="https://mahadbtmahait.gov.in/SchemeData/SchemeData?str=E9DDFA703C38E51AA07C7E01997E4885"
            target="blank">View</a></button>
      </div>
      <div class="dbatu">
        <img src="engg.png" width="100%" height="180px">
        <h5 class="card-title"><a href="https://www.enggsolution.com/" target="blank">ENGG-SOLN</a></h5>
        <p class="card-text">Enggsolution provides all in one solution for Acadecmics , Trainings and placements for
    ...
    <ul>
      ...
      <div class="sb">
        <li><img src="sid.jpg"><br>
          <p><strong>&nbsp;&nbsp; &nbsp; &nbsp;Jr. Developer &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;</strong><br>Higher
            & Technical Education</p>
        </li>
      </div>
      <div class="pp">
        <li><img src="hr.jpg"><br>
          <p><strong>&nbsp;&nbsp;&nbsp;Project Designer &nbsp;&nbsp;&nbsp;&nbsp;</strong><br>Higher & Technical
            Education</p>
        </li>
      </div>
      <div class="vrs">
        <li><img src="sahil.jpg"><br>
          <p><strong>&nbsp;&nbsp;Assistant Manager &nbsp;&nbsp;&nbsp;</strong><br>Higher & Technical Education</p>
        </li>
      </div>
      <div class="ds">
        <li><img src="yash.jpg"><br>
          <p><strong>&nbsp;&nbsp;Project Secreatery &nbsp;&nbsp;&nbsp;</strong><br>Higher & Technical Education</p>
        </li>
      </div>
    </ul>
  </div>
  <div id="info">
    <div class="main">
      <h3><i class="fa fa-users" aria-hidden="true">&nbsp;</i>About Group</h3>
      <hr>
      <p>Designed to provide Question Papers, Solutions &<br> Notes mcq questions with answers pdf<br> Lonere university
        by <strong>DAV.</strong></p>
    </div>
    <div id="usl" class="main">
      <h3 class="ful"><i class="fa fa-link" aria-hidden="true">&nbsp;</i>Useful Links</h3>
      <a href="https://gcoey.ac.in/">
        <p class="use">gcoey.ac</p>
      </a>
    </div>
    <div id="contact" class="main">
      <div class="coni">
        <h3><i class="fa fa-user-circle" aria-hidden="true">&nbsp;</i>Contact Info</h3>
      </div>
      <hr>
      <div class="conii">
        <ul>
